...
match priority:
    ...
    case ("medium"):
        if(time_bound == "yes"):
            ...
            print(f"Reminder: '{task}' is a medium priority task. Please schedule it accordingly.")
    case ("low"):
        if(time_bound == "yes"):
            print(f"Note: '{task}' is a low priority task that can be done at your convenience.")
        else:
